...
function Video() {
    ...
    return (
        <div
            ref={parent}
            className="h-screen relative w-full bg-black text-white overflow-hidden"
        >
            <div className="absolute top-[50%] left-[50%] -translate-x-[50%] -translate-y-[50%] h-fit w-full">
                ...
                <div
                    ref={videoParent}
                    className="text-[10vw] flex items-center justify-center gap-[50%] md:py-20 py-32 relative"
                >
                    <video muted autoPlay loop
                        ref={videoDev}
                        className="aspect-video absolute w-[20%] opacity-40"
